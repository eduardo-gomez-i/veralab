...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const cookieUser = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('auth_token');
        if (cookieUser) {
            try {
...
const OrderProvider = ({ children })=>{
    ...
    const [allOrders, setAllOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]); // Store all fetched orders locally for filtering
    ...
    const addOrder = async (orderData, attachment)=>{
        if (!user) return;
        setLoading(true);
        try {
            ...
            form.append('prosthesisType', orderData.prosthesisType);
            form.append('material', orderData.material);
            ...
            form.append('priority', orderData.priority);
    ...
    const updateOrderAttachment = async (orderId, attachment)=>{
        setLoading(true);
        try {
            const form = new FormData();
            form.append('attachment', attachment);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77bd8244._.js.map