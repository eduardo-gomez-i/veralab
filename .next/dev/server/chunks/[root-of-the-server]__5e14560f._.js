...
async function POST(request) {
    try {
        ...
        const ensureUploadsDir = async ()=>{
            const uploadsDir = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads');
        ...
        if (contentType.includes('multipart/form-data')) {
            ...
            if (file && typeof file === 'object' && file.size > 0) {
                ...
                const ext = file.type === 'application/pdf' ? 'pdf' : file.type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' ? 'docx' : file.type.startsWith('image/') ? file.type.split('/')[1] : 'bin';
                const filename = `${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID()}.${ext}`;
                const uploadsDir = await ensureUploadsDir();
                const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(uploadsDir, filename);
                await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].writeFile(filePath, buffer);
        ...
        if (!payload.dentistId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID del dentista es requerido'
            }, {
                status: 400
            });
        }
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].order.create({
            data: {
                ...
                estimatedDeliveryDate: payload.estimatedDeliveryDate ? new Date(payload.estimatedDeliveryDate) : undefined,
                dentistName: payload.dentistName || 'Desconocido',
                dentist: {
                    connect: {
                        id: payload.dentistId
                    }
                }
            }
        });
        ...
        const message = error instanceof Error && error.message ? error.message : 'Error al crear pedido';
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: message
        }, {
            status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5e14560f._.js.map