...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const cookieUser = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('auth_token');
            if (cookieUser) {
                try {
...
const OrderProvider = ({ children })=>{
    ...
    const [allOrders, setAllOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // Store all fetched orders locally for filtering
    ...
    const fetchOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OrderProvider.useCallback[fetchOrders]": async ()=>{
            if (!user) return;
            setLoading(true);
            try {
                ...
                if (user.role === 'dentista') {
                    data = data.filter({
                        "OrderProvider.useCallback[fetchOrders]": (o)=>o.dentistId === user.id
        ...
        "OrderProvider.useEffect": ()=>{
            ...
            if (filters.status && filters.status !== 'all') {
                filteredData = filteredData.filter({
                    "OrderProvider.useEffect": (o)=>o.status === filters.status
                }["OrderProvider.useEffect"]);
            }
            if (filters.searchTerm) {
                const term = filters.searchTerm.toLowerCase();
                filteredData = filteredData.filter({
                    "OrderProvider.useEffect": (o)=>o.patientName.toLowerCase().includes(term) || o.id.toLowerCase().includes(term)
                }["OrderProvider.useEffect"]);
            }
...
_s(OrderProvider, "0Vm73IJRKxo2Tt4rV6nkWCHLZ2o=", false, function() {
    return [
...
//# sourceMappingURL=src_ef7c0da4._.js.map